...
public class AppRater {
    private final static String APP_TITLE = "Color Tap Frenzy";// App Name
    private final static String APP_PNAME = "com.GigantDevs.ca.rgb";// Package Name
    ...
    public static void app_launched(Context mContext) {
        ...
        if (launch_count >= LAUNCHES_UNTIL_PROMPT) {
            if (System.currentTimeMillis() >= date_firstLaunch +
                ...
                showAlertDialogButtonClicked(mContext, editor);
            }
        }
    ...
    public static void showAlertDialogButtonClicked(final Context mContext, final SharedPreferences.Editor editor) {
